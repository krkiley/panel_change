...
```{r dag, message=FALSE, fig.width=6.8, fig.cap="Graphical representation of active updating and settled dispositions models over time."}
library(ggdag)
library(dagitty)
aum <- 
  dagitty("dag {
...
Our results ultimately suggest that real, persistent attitude change is an uncommon phenomenon among adults. Understanding the social origins of individuals' attitudes requires greater focus on the "conditions of past production" that give rise to persistent beliefs in adulthood.
